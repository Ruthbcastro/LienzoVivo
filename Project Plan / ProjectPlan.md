# Project Plan: Lienzo Vivo

## First Delivery

### Expected Products and Results
- Lienzo Vivo Definition Document
- Lienzo Vivo Planning Document
- User Profiles and Scenarios Document
- Lienzo Vivo Requirements Document
- DCU Application in Lienzo Vivo Document

### Activity Schedule

| Deliverable / Activity | Estimated Duration | Start Date | End Date |
|------------------------|-----------------|------------|----------|
| Clarity of application definition (Lienzo Vivo Definition Document) | | | |
| Define application objective (Ecommerce for art and AR) | 1 day | 05-Sep | 05-Sep |
| Identify primary and secondary users | 1 day | 06-Sep | 06-Sep |
...
### Expected Products and Results
- Updated RF and NFR document and requirements traceability table toward design and prototypes
- Low and high-fidelity prototypes
- Interface design guidelines
- Interaction design documentation
- Inspection method results document
- Usability test planning document
- Prioritized usability NFR list
- Test instruments
...
| Deliverable / Activity | Estimated Duration | Start Date | End Date |
|------------------------|-----------------|------------|----------|
| Requirements Evolution (RF and NFR) | | | |
| Record significant changes in RF and NFR | 2 days | 01-Oct | 02-Oct |
| Review and improve clarity of requirement wording | 1 day | 03-Oct | 03-Oct |
...
### Expected Products and Results
- Progress document
- Document with development phases
- Test report
- Learnings document
- Slides with prototype
